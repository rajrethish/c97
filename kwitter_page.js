...
like_button ="<button class='btn btn-warning' id="+firebase_message-id+"+value="+like+"onclick='updaelike(this.id)'>";
span_with_tag = "<span class='glypicom-thumbs-up'>like:"+like+"</span></button><hr>";
...
{
      console.log("clicked on like button-"+ message-id);
